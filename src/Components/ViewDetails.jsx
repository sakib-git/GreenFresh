...
<hr className='text-[#d4d9df]' />
            ...
            <div className="flex flex-wrap items-center gap-4 pt-6">
              ...
              <button className="flex-1 flex items-center justify-center gap-3 py-4 px-8 rounded-2xl bg-[#00c662] text-white font-bold text-lg hover:bg-[#00a852] shadow-lg shadow-green-100 transition-all duration-300 transform active:scale-95">
