      ...
      <div className="bg-[#312c85]">
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center p-10 text-white">
            <h1 className="text-[clamp(1.875rem,1.2015rem+2.9126vw,3.75rem)] font-semibold">Connect With Us</h1>
          ...
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <input type="text" placeholder="Your Name" className="w-full p-4 bg-gray-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white rounded-2xl outline-none transition-all" />
              </div>
              {/* Email Address */}
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-800 uppercase tracking-wider">Email Address</label>
                <input type="email" placeholder="yourname@gmail.com" className="w-full p-4 bg-gray-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white rounded-2xl outline-none transition-all" />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <input type="text" placeholder="How can we help?" className="w-full p-4 bg-gray-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white rounded-2xl outline-none transition-all" />
            </div>

            {/* Message */}
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-800 uppercase tracking-wider">Message</label>
              <textarea rows="5" placeholder="Write your message here..." className="w-full p-4 bg-gray-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white rounded-2xl outline-none transition-all"></textarea>
            </div>

            {/* Submit Button */}
            <button type='submit' className="w-full py-4 bg-[#5433FF] hover:bg-[#4528d8] text-white font-bold rounded-2xl shadow-lg transition-all uppercase tracking-widest text-sm">Send Message</button>
          </form>
        </div>
      </div>
</div>
